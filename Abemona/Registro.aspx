    ...
    <div style="margin: 50px 50px;">
        ...
        <div class="row">
            <div class="col-4">
                ...
                <div id="botones">
                    <asp:Button Text="Ingresar" CssClass="btn botonn btnhover" Style="background-color: black; color: #e8ca01; font-weight: bolder;" ID="btnRegistro" OnClick="btnRegistro_Click" runat="server" CausesValidation="true" />
                    <a href="/" class="lab botonn2 " style="color: black!important; margin-left: 5px; font-family: sans-serif; position: relative; bottom: -3px;">Cancelar</a>
