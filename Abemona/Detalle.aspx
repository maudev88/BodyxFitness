        ...
        <div style="display: flex; justify-content: space-around;">
            ...
            <div class="d-flex flex-column gap-3" id="datos">
                ...
                <div style="display: flex; justify-content: space-around;" class="align-items-lg-center botoGrandes">
                    <div class="botonnDiv">
                        <asp:Button Text="Ir al Catálogo" ID="btnVolver" CssClass="btn botonn d-block mx-auto mt-xxl-5 botones" OnClick="btnVolver_Click" runat="server" Style="color: #e8ca01; background-color: black;" />
                    </div>
