        ...
        <div class="row" id="sinH1">
            <div class="col-md-4">
                ...
                <div class="col-md-4" style="display: flex;" id="botones">
                    <asp:Button Text="Guardar" OnClick="btnGuardar_Click" CssClass="btn botonn" Style="background-color: black; color: #e8ca01; font-weight: bolder;" ID="btnGuardar" runat="server" />
                    <a href="/" class="botonn2 lab" style="color: black!important; margin-left: 5px; font-family: sans-serif; position: relative; bottom: -8px;">Regresar</a>
                </div>
            </div>
