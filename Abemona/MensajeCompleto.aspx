...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .espan {
            border-bottom: 3px #e8ca01 solid;
            color: #e8ca01;
        }
    ...
    <div class="d-flex flex-column gap-3" style="text-align: center; margin-top: 50px">
        ...
        <div class="d-flex flex-column align-items-center gap-4">
            ...
            <div class="d-flex" style="gap: 129px;">
                <div><a href="Mensajes.aspx" class="btn botones" style="background-color: black; font-family: Quicksand; color: #e8ca01; font-weight: bolder;">Volver</a></div>
                <div>
